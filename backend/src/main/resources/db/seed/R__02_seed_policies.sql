...
VALUES ((SELECT id FROM policy_names WHERE identifier = 'serviceTerms'),
       ...
       ((SELECT id FROM policy_names WHERE identifier = 'thirdPartyRealIdentityDisclosure'),
        '1.0', 'legal/third-party-real-identity-disclosure/v1.0.html', TRUE, '2026-08-02 15:00:00'),
       ((SELECT id FROM policy_names WHERE identifier = 'serviceTerms'),
        '1.2', 'legal/service-terms/v1.2.html', TRUE, '2026-09-15 15:00:00'),
       ((SELECT id FROM policy_names WHERE identifier = 'privacyPolicy'),
        '1.2', 'legal/privacy-policy/v1.2.html', TRUE, '2026-09-15 15:00:00'),
       ((SELECT id FROM policy_names WHERE identifier = 'privacyCollectionConsent'),
        '1.2', 'legal/privacy-collection-consent/v1.2.html', TRUE, '2026-09-15 15:00:00'),
       ((SELECT id FROM policy_names WHERE identifier = 'ageRestrictionPolicy'),
        '1.2', 'legal/age-restriction-policy/v1.2.html', TRUE, '2026-09-15 15:00:00'),
       ((SELECT id FROM policy_names WHERE identifier = 'thirdPartyRealIdentityDisclosure'),
        '1.1', 'legal/third-party-real-identity-disclosure/v1.1.html', TRUE, '2026-09-15 15:00:00'),
       ((SELECT id FROM policy_names WHERE identifier = 'paidServiceRefundPolicy'),
        '1.1', 'legal/paid-service-refund-policy/v1.1.html', TRUE, '2026-09-15 15:00:00') AS new
