...
CREATE TABLE anon_session_persona_elements (
    id               BIGINT NOT NULL AUTO_INCREMENT,
    anon_session_id  BIGINT NOT NULL,
    dimension        ENUM ('OPENNESS','CONSCIENTIOUSNESS','EXTRAVERSION','AGREEABLENESS','NEUROTICISM','LIFE_STYLE','CONFLICT_STYLE','COMMUNICATION_STYLE','INTERESTS','DETAIL') NOT NULL,
