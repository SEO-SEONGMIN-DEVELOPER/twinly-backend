...
public enum ErrorCode {
    ...
    EMAIL_DOMAIN_NOT_SUPPORTED(HttpStatus.UNPROCESSABLE_CONTENT, "가입할 수 없는 이메일 도메인입니다."),
    ...
    SIMULATION_CONSENT_REQUIRED(HttpStatus.FORBIDDEN, "평행우주 입장에 필요한 필수 약관에 동의하지 않았습니다."),
