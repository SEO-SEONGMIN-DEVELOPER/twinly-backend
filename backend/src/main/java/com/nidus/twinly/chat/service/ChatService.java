...
public class ChatService {
    ...
    @Transactional
    public ChatCommonPointResult commonPoint(Long userId, Long roomId) {
        ChatRoom room = chatRoomRepository.findById(roomId)
                .orElseThrow(() -> new BusinessException(ErrorCode.ROOM_NOT_FOUND));
        ...
        List<PersonaElement> partnerPersona = personaElementRepository.findAllByUserIdOrderByIdAsc(partnerId);

        if (myPersona.isEmpty() || partnerPersona.isEmpty()) {
